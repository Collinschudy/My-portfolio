...
const Contact = () => {
  return (
    <div className="flex sm:flex-row sm:h-[30rem] flex-col">
      <div className="w-full sm:w-[50%] flex flex-col px-[2rem] lg:px-[4rem] md:px-[3rem]">
        <h2 className="sm:text-[40px] text-orange-800">Contact Me</h2>
        <p className="text-gray-800">You can reach out to me</p>
        <span className="bg-gray-100 w-[6em] h-[6px] rounded-l-lg rounded-r-lg mt-[1em] mb-[1rem]"></span>
